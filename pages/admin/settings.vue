          ...
          <v-card-text class="pa-6">
            ...
            <v-form v-else ref="form" @submit.prevent="saveConfig">
              <v-tabs v-model="activeTab" class="mb-6">
                ...
                <v-tab value="function">功能设置</v-tab>
              </v-tabs>
              ...
              <v-window v-model="activeTab">
                ...
                <v-window-item value="display">
                  ...
                  <v-textarea
                    v-model="config.analyticsCode"
                    label="统计代码"
                    variant="outlined"
                    rows="4"
                    hint="如 Google Analytics、百度统计等"
                    class="mb-4"
                  />
                </v-window-item>
                ...
                <v-window-item value="function">
                  ...
                  <v-switch
                    v-model="config.commentNeedReview"
                    label="评论需要审核"
                    color="tertiary"
                    class="mb-4"
                    inset
