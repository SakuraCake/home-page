<template>
  <v-row justify="center" class="ga-2">
    <v-col v-for="link in socialLinks" :key="link.name" cols="auto">
      <v-btn :href="link.url" target="_blank" rel="noopener noreferrer" variant="tonal" size="large" class="text-none">
        <template #prepend>
